...
//  TicTacToe
//
//  Created by Neil Richter on 21/06/2019.
...
class LogsViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        let retrievedLogs: [String] = UserDefaults.standard.array(forKey: "logs") as? [String] ?? [] as! [String]
        return retrievedLogs.count
    }
